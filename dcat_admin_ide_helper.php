...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection sap_code
     ...
     * @property Grid\Column|Collection stop_at
     ...
     * @method Grid\Column|Collection sap_code(string $label = null)
     ...
     * @method Grid\Column|Collection stop_at(string $label = null)
     ...
     * @property Show\Field|Collection sap_code
     ...
     * @property Show\Field|Collection stop_at
     ...
     * @method Show\Field|Collection sap_code(string $label = null)
     ...
     * @method Show\Field|Collection stop_at(string $label = null)
